...
###############################################################
        ...
        annotation_json_dir_coco = os.path.join(session_dir, "COCO", full_image_name, "Dataset", chunk_pct, overlap, "chunks", "annotated_json_chunks")
        ...
        if "createML" in json_formats:
            ...
            annotation_json_dir_createML = os.path.join(session_dir, "createML", full_image_name, "Dataset", chunk_pct, overlap, "chunks", "annotated_json_chunks")
        ...
        annotation_img_dir = os.path.join(session_dir,full_image_name, "Visualize", chunk_pct, overlap, "annotated_chunks")
        ...
        for json_format in json_formats:
            copy_chunks_img_dir = os.path.join(session_dir, json_format, full_image_name, "Visualize", chunk_pct, overlap, "annotated_chunks")
        ...
        for json_format in json_formats:
            copy_chunks_img_dir = os.path.join(session_dir, json_format, full_image_name, "Dataset", chunk_pct, overlap, "chunks", "images")
            os.makedirs(copy_chunks_img_dir, exist_ok=True)
            # Copy image
